...
{
    /// <summary>
    /// Handles mouse tracking over the surface mesh and shows a 3D annotation with coordinates.
    /// </summary>
    internal class MouseTrackingService
    {
        public void HandleMouseMove(
            SurfaceMeshSeries3D? surfaceSeries,
            Annotation3D? mouseTrackAnnotation,

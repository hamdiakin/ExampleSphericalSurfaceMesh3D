...
{
    /// <summary>
    /// Encapsulates camera projection, orientation, distance, and dimension handling.
    /// </summary>
    internal class CameraService
    {
        ...
        public void SetProjection(
            ...
            int selectedProjectionIndex,
            ref PointDoubleXYZ? oldDimensions,
            ref PointDoubleXYZ? oldDimensionsLegacy,
            Action<bool> setIsDistanceEnabled,
        ...
        public void SetTopView2D(
            View3DBase view,
            LightningChart chart,
            ref PointDoubleXYZ? oldDimensions,
            ref PointDoubleXYZ? oldDimensionsLegacy,
            Action<int> setSelectedProjectionIndex,
            Action<int> setSelectedCameraIndex,
            Action<double> setVerticalRotation,
            Action<double> setHorizontalRotation,
            Action<double> setSideRotation,
            Action<PointDoubleXYZ?> resetDimensions)
        {
            if (view == null || chart == null) return;

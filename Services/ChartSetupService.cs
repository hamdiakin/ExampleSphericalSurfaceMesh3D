...
{
    public class ChartSetupService
    {
        ...
        private void SetSurfacePointValues(SurfacePoint[,] xyzData, SphericalPoint[,] sphericalData)
        {
        ...
        private void ConfigureSurfaceSeries(SurfaceMeshSeries3D series)
        {
            series.WireframeOffset.SetValues(0, 0, 0);
            series.WireframeLineStyle.Color = Color.FromArgb(40, 0, 0, 0);
            series.ContourLineType = ContourLineType3D.None;
            series.ContourPalette = dataService.CreatePalette(series, 100);
            series.ColorSaturation = 80;
            series.Title.Text = "Field density";
        }
